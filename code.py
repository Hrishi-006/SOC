...
n = int(0.9*len(data)) # first 90% will be train, rest validation set
train_data = data[:n]
val_data = data[n:]
...
learning_rate = 3e-4
# create a PyTorch optimizer- adam ajusts the learning rate to perform gradient descent optimally
